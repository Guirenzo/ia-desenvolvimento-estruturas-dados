...
## 4. Objetivo
Encontrar todos os trios distintos do array cuja soma seja zero.
...
Array + Ordenação + Two Pointers

## 7. Por que essa estrutura é adequada
Ordenar o array permite usar two pointers para reduzir a complexidade e tratar duplicados com clareza.

## 8. Estratégia de solução
Ordenar o array, fixar um elemento e usar dois ponteiros para buscar pares complementares.
...
## 11. Complexidade
- Tempo: `O(n²)`
- Espaço: `O(1) adicional, desconsiderando a saída`
...
## 15. Conclusão
Este problema foi importante para revisar o uso de **Array + Ordenação + Two Pointers** em um contexto clássico de entrevistas técnicas, reforçando análise de eficiência, clareza de implementação e validação por testes.
