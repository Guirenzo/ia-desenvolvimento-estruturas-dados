...
## 4. Objetivo
Encontrar os índices de dois números do array cuja soma seja igual ao valor alvo.
...
O array é a entrada principal, e o hash map permite encontrar o complemento necessário em tempo constante médio.

## 8. Estratégia de solução
Percorrer o array uma única vez, calcular o complemento e verificar se ele já apareceu.
...
## 15. Conclusão
Este problema foi importante para revisar o uso de **Array + Hash Map** em um contexto clássico de entrevistas técnicas, reforçando análise de eficiência, clareza de implementação e validação por testes.
