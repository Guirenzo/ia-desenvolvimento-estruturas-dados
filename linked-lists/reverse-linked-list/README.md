...
## 4. Objetivo
Inverter completamente uma lista encadeada simples.
...
O problema exige manipulação direta dos ponteiros entre os nós, o que torna linked list a estrutura central da solução.

## 8. Estratégia de solução
Percorrer a lista e inverter os ponteiros um a um usando referências para anterior, atual e próximo.
