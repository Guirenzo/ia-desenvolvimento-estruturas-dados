...
## 4. Objetivo
Implementar uma pilha que permita recuperar o menor elemento em tempo constante.
...
A solução exige modelagem de pilha com suporte adicional para manter o mínimo atualizado a cada operação.

## 8. Estratégia de solução
Manter uma pilha principal e uma pilha auxiliar de mínimos.
