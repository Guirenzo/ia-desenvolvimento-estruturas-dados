...
## 4. Objetivo
Informar, para cada dia, quantos dias faltam até uma temperatura mais alta.
...
A monotonic stack permite manter índices de temperaturas ainda não resolvidas e atualizá-las em tempo linear.

## 8. Estratégia de solução
Percorrer o array guardando índices em pilha decrescente e resolver posições quando uma temperatura maior aparece.
...
## 15. Conclusão
Este problema foi importante para revisar o uso de **Monotonic Stack** em um contexto clássico de entrevistas técnicas, reforçando análise de eficiência, clareza de implementação e validação por testes.
